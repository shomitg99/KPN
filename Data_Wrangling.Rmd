...
full5 <- subset(full4, subset = strat_new == "Acquisition" | strat_new == "Churn" | strat_new == "Xsell" | strat_new == "Upsell")

table(full5$strat_new)

acq <- subset(full5, subset = strat_new == "Acquisition")
churn <- subset(full5, subset = strat_new == "Churn")
xsell <- subset(full5, subset = strat_new == "Xsell")
upsell <- subset(full5, subset = strat_new == "Upsell")

save(full5, file = "cleaned.RData")
